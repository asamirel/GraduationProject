...
namespace CameraCapture
{
    public partial class CheckFrames : Form
    {
        ...
        public CheckFrames(List<Bitmap> extFaces)
        {
            InitializeComponent();
            ExtFaces = extFaces;
            Image<Gray, byte> ExtracreFaceAsImage = new Image<Gray, byte>(ExtFaces[0]).Resize(295, 268, Inter.Cubic);
            imageBox1.Image = ExtracreFaceAsImage;
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Image<Gray, byte> ExtracreFaceAsImage = new Image<Gray, byte>(ExtFaces[count]).Resize(295, 268, Inter.Cubic);
